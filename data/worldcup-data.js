...
const WC_DATA = {
  tournament: {
    ...
    teamsCount: 48,
    matchesCount: 104,
    currentPhase: "⚽ 16強賽 (Round of 16) 全數完成 ✅ ｜ 🏆 8強全數出爐！🇲🇦摩洛哥vs🇫🇷法國（7/9·福克斯堡）、🇪🇸西班牙vs🇧🇪比利時（7/10·洛杉磯SoFi）、🇳🇴挪威vs🇬🇧英格蘭（7/11·邁阿密）、🇦🇷阿根廷vs🇨🇭瑞士（7/11·堪薩斯城） ｜ 📅 7/8更新：16強賽全部結束✅ 8強賽明日起開打🔥 ｜ 🏆 8強賽程：🇫🇷法國vs🇲🇦摩洛哥（7/9 20:00 ET·福克斯堡）、🇪🇸西班牙vs🇧🇪比利時（7/10 15:00 ET·洛杉磯SoFi）、🇳🇴挪威vs🇬🇧英格蘭（7/11 17:00 ET·邁阿密）、🇦🇷阿根廷vs🇨🇭瑞士（7/11 21:00 ET·堪薩斯城） ｜ 🥇 Haaland、Mbappé、Messi各以7球並列金靴榜首｜ 🏅 Messi世界盃第21球創歷史新高｜🇬🇧Kane 14球｜ 🇦🇷阿根廷3-2🇪🇬埃及驚天逆轉 — Messi第83分鐘扳平、Enzo Fernandez第90+2分鐘絕殺🔥 ｜ 🇨🇭瑞士0-0(4-3)哥倫比亞 — 自1954年以來首闖8強！Gregor Kobel PK英雄",
  },
